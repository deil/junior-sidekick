...
object Prompts {
    ...
    const val IMAGE_SUMMARIZATION_PROMPT =
        "plz extract factual context from this image - visible text, titles, names, UI, state, diagrams, errors, etc. no guessing, facts only. return only text"
}
