...
- `core/src/main/kotlin/com/github/uncomplexco/sidekick/application/agent/skills/SkillCatalogReloader.kt` – defines the skill catalog reload interface used by tools.
