    ...
    companion object {
        ...
        fun prefixCases(): Stream<PrefixCase> {
            return Stream.of(
                ...
                PrefixCase(Path.of("/srv/sidekick/data"), Path.of("/srv/sidekick/data/state/session/scratch/bash"), true),
                PrefixCase(Path.of("/srv/sidekick/data"), Path.of("/srv/sidekick/data-backup/state/session"), false),
                PrefixCase(Path.of("/srv/sidekick/data/state"), Path.of("/srv/sidekick/data/state/c123/scratch/bash"), true),
