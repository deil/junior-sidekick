    ...
    companion object {
        ...
        fun prefixCases(): Stream<PrefixCase> {
            return Stream.of(
                ...
                PrefixCase(
                    Path.of("/srv/sidekick/data"),
                    Path.of("/srv/sidekick/data/state/session/work"),
                    true,
                ),
                PrefixCase(
                    Path.of("/srv/sidekick/data"),
                    Path.of("/srv/sidekick/data-backup/state/session"),
                    false,
                ),
                PrefixCase(
                    Path.of("/srv/sidekick/data/state"),
                    Path.of("/srv/sidekick/data/state/c123/work"),
                    true,
                ),
                PrefixCase(
                    Path.of("/srv/sidekick/data/state"),
                    Path.of("/srv/sidekick/data/stateful/c123"),
                    false,
                ),
